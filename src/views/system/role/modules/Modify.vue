    ...
    >
      <div class="grid grid-cols-2 gap-x-20px">
        ...
        <a-form-item label="部门ID" name="deptId">
          <a-input v-model:value="formState.deptId" placeholder="请输入"></a-input>
        </a-form-item>
        <a-form-item label="岗位ID" name="positionId">
          <a-input v-model:value="formState.positionId" placeholder="请输入"></a-input>
        </a-form-item>
        <a-form-item label="产品编码" name="productCode">
          <a-input v-model:value="formState.productCode" placeholder="请输入"></a-input>
        </a-form-item>
        <a-form-item label="数据范围（1：全部数据权限 2:本租户数据权限 3：本部门数据权限 4：本部门及以下数据权限 5：本项目数据权限）" name="dataScope">
          <a-input v-model:value="formState.dataScope" placeholder="请输入"></a-input>
        </a-form-item>
