  ...
  <g-page-body>
    <template #header>
      <g-params :loading="tableState.loading" @search="methods.searchQuery()">
        ...
        <!-- 密码，系统登录必选，第三方登录可空搜索 -->
        <a-input
          v-model:value="queryParams.password"
          placeholder="输入密码，系统登录必选，第三方登录可空搜索..."
          @keydown.enter="methods.searchQuery()"
        ></a-input>
        <!-- 账号类型 0 系统账号 1 微信 搜索 -->
        <a-input
          v-model:value="queryParams.type"
          placeholder="输入账号类型 0 系统账号 1 微信 搜索..."
          @keydown.enter="methods.searchQuery()"
        ></a-input>
        <!-- 状态（0正常 1停用）搜索 -->
        <a-input
...
const tableState = reactive({
  ...
  columns: [
    ...
    { title: '密码，系统登录必选，第三方登录可空', dataIndex: "password" },
    { title: '账号类型 0 系统账号 1 微信 ', dataIndex: "type" },
