  ...
  >
    ...
    >
      <div class="grid grid-cols-2 gap-x-20px">
        ...
        <a-form-item label="用户类型（0系统用户）" name="type">
        ...
        <a-form-item label="手机号码" name="phoneNumber">
          <a-input v-model:value="formState.phoneNumber" placeholder="请输入"></a-input>
        </a-form-item>
        <a-form-item label="用户性别（0男 1女 2未知）" name="sex">
          <a-input v-model:value="formState.sex" placeholder="请输入"></a-input>
        </a-form-item>
        <a-form-item label="头像地址" name="avatar">
          <a-input v-model:value="formState.avatar" placeholder="请输入"></a-input>
        </a-form-item>
